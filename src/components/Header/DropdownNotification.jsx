  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      <li>
        ...
        {dropdownOpen && (
          <div className="absolute -right-27 mt-2.5 flex h-90 w-75 sm:w-80 flex-col rounded-sm  border-gray-2 bg-white shadow-default">
              ...
              {notifs.length > 0 ? (
                notifs.map((notif) => (
                  ...
                  >
                    ...
                    {/* <p className="text-sm">
                    <span className="text-black">{notif.message}</span>
                  </p> */}
                    <p className="text-xs">
                ...
                <p className="text-center mt-5 text-bodydark2 font-bold">
