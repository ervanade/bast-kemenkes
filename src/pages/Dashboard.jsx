...
[
  ...
  <div className="w-full bg-transpatent border border-[#cacaca] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img className="rounded-t-lg max-h-64 w-full object-cover"  src={item.img} alt="article" />
    </a>
    <div className="p-5">
        {/* <a href="#" className=""> */}
            <p className="mb-4 text-xl lg:text-2xl font-medium tracking-tight text-gray-900 dark:text-white line-clamp-2">{item.title}</p>
        {/* </a> */}
        <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-primary rounded-lg hover:bg-primary focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-primary dark:hover:bg-primary dark:focus:ring-primary">
            Read more
